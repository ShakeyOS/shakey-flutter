...
import 'package:flutter_shakey_example_app/chat_screen.dart';
import 'package:http/http.dart' as http;

class AtiveAgent extends StatefulWidget {
  final String? walletPublicKey;
  const AtiveAgent({super.key, this.walletPublicKey});
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Text(widget.walletPublicKey != null
                ? '${widget.walletPublicKey!.substring(0, 4)}...${widget.walletPublicKey!.substring(widget.walletPublicKey!.length - 4)}'
